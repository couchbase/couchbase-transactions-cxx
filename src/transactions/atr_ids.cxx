...
const std::vector<std::string> &tx::atr_ids::all()
{
    return ATR_IDS;
}

const std::string &tx::atr_ids::atr_id_for_vbucket(int vbucket_id)
{
...
int tx::atr_ids::vbucket_for_key(const std::string &key)
{
